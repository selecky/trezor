class Strings {
  ...
  static String emptyCredListText = 'Your Trezor is empty.';
  static String addCredentialsInfo = 'Click + to add some credentials.';
  ...
  static String ok = 'Ok';
  static String setPin = 'Set your PIN';
  static String pin = 'PIN';
  static String savePin = 'Save PIN';
  static String insertPin = 'Insert your PIN';
  static String pinIncorrect = 'Incorrect PIN';
  static String pinIncorrectInfo = 'Entered PIN is not correct';
